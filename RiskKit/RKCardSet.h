...
- (nullable instancetype)initCardSet:(null_unspecified RKCard *)aCard1 :(null_unspecified RKCard *)aCard2 :(null_unspecified RKCard *)aCard3 NS_DESIGNATED_INITIALIZER;
