...
- (instancetype)initCardType:(RiskCardType)aCardType withCountry:(nullable Country *)aCountry imageNamed:(NSImageName)anImageName;
- (instancetype)initWithCardType:(RiskCardType)aCardType withCountry:(nullable Country *)aCountry imageNamed:(NSImageName)anImageName bundle:(NSBundle*)bundle NS_DESIGNATED_INITIALIZER;
